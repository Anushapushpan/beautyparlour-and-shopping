...
driver.get("http://127.0.0.1:8000/admin/ShoppingApp/product/add/")
...
discount_field = driver.find_element(By.NAME, "discount")
discount_field.send_keys("5")
stock_field = driver.find_element(By.NAME, "stock")
stock_field.send_keys("90")

# Submit the form
stock_field.send_keys(Keys.RETURN)
