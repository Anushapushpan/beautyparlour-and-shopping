...
driver.get("http://127.0.0.1:8000/appointment")


service_field = driver.find_element(By.NAME, "service")
service_field.send_keys("Manicure")

date_field = driver.find_element(By.NAME, "date")
date_field.send_keys("11-05-2023")

time_field = driver.find_element(By.NAME, "time")
time_field.send_keys("2pm to 3pm")
...
dashboard_element = driver.find_element(By.XPATH, '/html/body/main/center/div[2]/div/div/form/center/div/input')
