...
review_field = driver.find_element(By.NAME, "opinion")
review_field.send_keys("good")
# Submit the form
review_field.send_keys(Keys.RETURN)
# Wait for the page to load and check for the presence of the dashboard element
dashboard_element = driver.find_element(By.XPATH, '/html/body/div[1]/div[2]/div/div[2]/div[2]/form/div[2]/button')
